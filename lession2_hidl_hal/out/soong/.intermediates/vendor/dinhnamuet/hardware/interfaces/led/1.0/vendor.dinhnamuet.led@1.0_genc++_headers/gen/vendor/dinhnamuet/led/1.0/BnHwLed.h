#ifndef HIDL_GENERATED_VENDOR_DINHNAMUET_LED_V1_0_BNHWLED_H
#define HIDL_GENERATED_VENDOR_DINHNAMUET_LED_V1_0_BNHWLED_H
...
struct BnHwLed : public ::android::hidl::base::V1_0::BnHwBase {
    ...
    static ::android::status_t _hidl_getLed(
    ...
    static ::android::status_t _hidl_setLed(
            ::android::hidl::base::V1_0::BnHwBase* _hidl_this,
            const ::android::hardware::Parcel &_hidl_data,
            ::android::hardware::Parcel *_hidl_reply,
            TransactCallback _hidl_cb);
...
#endif  // HIDL_GENERATED_VENDOR_DINHNAMUET_LED_V1_0_BNHWLED_H
